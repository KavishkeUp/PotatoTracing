...
class MLPredictor {
    ...
    calculateConfidence(prediction) {
        // Simple confidence calculation based on LKR price range
        if (prediction >= 50.0 && prediction <= 500.0) {
            return 0.9; // High confidence for reasonable LKR prices
        } else if (prediction >= 20.0 && prediction <= 800.0) {
